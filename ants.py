...
class Ant(Insect):
    ...
    def add_to(self, place):
        if place.ant is None:
            ...
            # BEGIN Problem 8b
            if self.is_container == True and place.ant.is_container == False and self.can_contain(place.ant) == True:
                self.store_ant(place.ant)
                place.ant = self

            elif self.is_container == False and place.ant.is_container == True and place.ant.can_contain(self) == True:
    ...
    def double(self):
        ...
        # BEGIN Problem 12
        "*** YOUR CODE HERE ***"
        if self.doublealready == False:
            self.damage *= 2
            self.doublealready = True
        if self.is_container and self.ant_contained != None and self.ant_contained.doublealready == False:
            self.ant_contained.damage *= 2
            self.ant_contained.doublealready = True
        # END Problem 12
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        while not currentplace.is_hive:
            if currentplace.bees and self.lower_bound <= count <= self.upper_bound:
    ...
    def reduce_health(self, amount):
        ...
        if (self.health - amount) == 0:
            for i in list(self.place.bees):
                newdamage = self.damage + amount
                i.reduce_health(newdamage)
        else:
            for i in list(self.place.bees):
...
# END Problem 12
    ...
    def construct(cls, gamestate):
        ...
        # BEGIN Problem 12
        "*** YOUR CODE HERE ***"
        if gamestate.queenhere == False:
            gamestate.queenhere = True
